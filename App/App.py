...
def insert_data(city, state, country, act_name, act_mail, act_mob, name, email, res_score, timestamp, no_of_pages, cand_level, skills, pdf_name):
    DB_table_name = 'user_data'
    insert_sql = "insert into " + DB_table_name + """
    values (0, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"""
    rec_values = (city, state, country, act_name, act_mail, act_mob, name, email, str(res_score), timestamp, str(no_of_pages), cand_level, skills, pdf_name)
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                insert_data((city), (state), (country), (act_name), (act_mail), (act_mob), resume_data['name'], resume_data['email'], str(resume_score), timestamp, str(resume_data['no_of_pages']),str(resume_data['skills']), str(rec_course), pdf_name)
